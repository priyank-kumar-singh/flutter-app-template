...
class FirebaseAuthService {
  ...
  Future<void> _authenticateUser({
    ...
    try {
      ...
      await onError(Status.firebase, e.message);
    } on SocketException catch (e) {
      await onError(Status.socket, e.message);
    } on PlatformException catch (e) {
      await onError(Status.socket, e.message);
    } on TimeoutException catch (e) {
      await onError(Status.timeout, e.message);
    } catch (e) {
      await onError(Status.exception, e.toString());
    }
  }
  ...
  Future<void> googleOAuth() async {
    ...
    try {
      ...
      if (googleUser != null) {
        ...
        await onError(Status.timeout, 'Process terminated');
      }
    } on FirebaseAuthException catch (e) {
      await onError(Status.firebase, e.message);
    } on PlatformException catch (e) {
